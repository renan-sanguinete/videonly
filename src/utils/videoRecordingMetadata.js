...
export function buildVideoRecordingMetadata({
  ...
  return {
    ...
    settings: {
      ...
      slowMotionTargetFps: settings.slowMotionTargetFps,
      slowMotionPlaybackFps: settings.slowMotionPlaybackFps,
      slowMotionMaxDurationMs: settings.slowMotionMaxDurationMs,
      timelapseMode: settings.timelapseMode,
      timelapseIntervalMs: settings.timelapseIntervalMs,
      timelapseMaxDurationMs: settings.timelapseMaxDurationMs,
      timelapseSpeedFactor: settings.timelapseSpeedFactor,
